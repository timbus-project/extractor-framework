...
public class RPMSoftwareExtractor implements IExtractor {

    static final String formatUUID = "d17250e8-af6e-5b84-8fab-404d5ecee47f";

    private BundleContext bundleContext;
    private final Logger log = LoggerFactory.getLogger(RPMSoftwareExtractor.class);

    public RPMSoftwareExtractor(BundleContext bundleContext) { this.bundleContext = bundleContext; }
